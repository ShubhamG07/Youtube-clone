      ...
      <div className={`videolist ${isMenuOpen ? "shift-right" : ""}`}>
        {filteredVideos ? (
          filteredVideos.length ? (
            ...
            <div className="novideofound">
              ...
              <h1>No Video Found for term {query}</h1>
        ...
        <div className={`filterbutton ${isMenuOpen ? "shift-right800" : ""}`}>
          ...
          <button
            ...
            onClick={() => handleFilter(2, "music")}
          >
            Music
          </button>
          <button
            className={activeButton === 3 ? "active" : ""}
            onClick={() => handleFilter(3, "people")}
          >
            People
          </button>
          <button
            className={activeButton === 4 ? "active" : ""}
            onClick={() => handleFilter(4, "education")}
          >
            Education
          </button>
          <button
            className={activeButton === 5 ? "active" : ""}
            onClick={() => handleFilter(5, "gaming")}
          >
            Gaming
          </button>
          <button
            className={activeButton === 6 ? "active" : ""}
            onClick={() => handleFilter(6, "ed sheeran")}
          >
            Ed Sheeran
          </button>
          <button
            className={activeButton === 7 ? "active" : ""}
            onClick={() => handleFilter(7, "adele")}
          >
            Adele
          </button>
          <button
            className={activeButton === 8 ? "active" : ""}
            onClick={() => handleFilter(8, "coldplay")}
          >
            Coldplay
          </button>
          <button
            className={activeButton === 9 ? "active" : ""}
            onClick={() => handleFilter(9, "shakira")}
          >
            Shakira
          </button>
          <button
            className={activeButton === 10 ? "active" : ""}
            onClick={() => handleFilter(10, "luis fonsi")}
          >
            Luis Fonsi
          </button>
        </div>
