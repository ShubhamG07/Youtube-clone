    ...
    <div className="commentdata" onClick={checktoggleMenu}>
      ...
      <div className="add-comment">
        <div className={isEditing ? "hide" : ""}>
          ...
          <span className="grey"> {timeAgo(comment.timestamp)}</span>
        </div>
        <p className="commentinput">
          <input
            type="text"
            value={editedText}
            disabled={!isEditing}
        ...
        {isAuthenticated ? (
          comment.userId == user._id ? (
            <div className="edit-delete" onClick={toggleEditMenu}>
      ...
      {isEditing && (
        <div className="edit-actions">
          <button className="commenteditbutton" onClick={handleEditComment}>
            Save
          </button>
          <button className="commenteditbutton" onClick={handleCancelEdit}>
            Cancel
          </button>
        </div>
      )}
