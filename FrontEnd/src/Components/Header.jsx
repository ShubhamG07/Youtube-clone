...
dispatch(checkAuthStatus());
    ...
    return(
          ...
          <div className="modal">
            <div className="modal-content">
              ...
              <div className="menu-items">
                ...
                <Link to="/"><i className="fa-solid fa-house fa-lg mlr-10"></i> Home </Link>
                </p>
                <p >
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true"className="mlr-10"><path clipRule="evenodd" d="M18.45 8.851c1.904-1.066 2.541-3.4 1.422-5.214-1.119-1.814-3.57-2.42-5.475-1.355L5.55 7.247c-1.29.722-2.049 2.069-1.968 3.491.081 1.423.989 2.683 2.353 3.268l.942.404-1.327.742c-1.904 1.066-2.541 3.4-1.422 5.214 1.119 1.814 3.57 2.421 5.475 1.355l8.847-4.965c1.29-.722 2.049-2.068 1.968-3.49-.081-1.423-.989-2.684-2.353-3.269l-.942-.403 1.327-.743ZM10 14.567a.25.25 0 00.374.217l4.45-2.567a.25.25 0 000-.433l-4.45-2.567a.25.25 0 00-.374.216v5.134Z" fillRule="evenodd"></path></svg>  Shorts
                </p>
                <p >
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" className="mlr-10"><path clipRule="evenodd" d="M5.5 3A1.5 1.5 0 004 4.5h16A1.5 1.5 0 0018.5 3h-13ZM2 7.5A1.5 1.5 0 013.5 6h17A1.5 1.5 0 0122 7.5v11a1.5 1.5 0 01-1.5 1.5h-17A1.5 1.5 0 012 18.5v-11Zm8 2.87a.5.5 0 01.752-.431L16 13l-5.248 3.061A.5.5 0 0110 15.63v-5.26Z" fillRule="evenodd"></path></svg> Subscriptions
                </p>
                </section>
                ...
                <section className="bb-2">
                    <h3>Explore</h3>
                    <p><i className="fa-solid fa-fire fa-lg mlr-10"></i>Trending</p>
                    <p><i className="fa-solid fa-bag-shopping fa-lg mlr-10"></i>Shopping</p>
                    <p><i className="fa-solid fa-music fa-lg mlr-10"></i>Music</p>
                    <p><i className="fa-solid fa-clapperboard fa-lg mlr-10"></i>Movies</p>
                    <p> <i className="fa-solid fa-satellite-dish  fa-lg mlr-10 "></i>Live</p>
                    <p><i className="fa-solid fa-gamepad fa-lg mlr-10 "></i>Gaming</p>
                    <p><i className="fa-solid fa-newspaper fa-lg mlr-10 "></i>News</p>
                    <p><i className="fa-solid fa-trophy fa-lg mlr-10 "></i>Sports</p>
                    <p> <i className="fa-solid fa-graduation-cap fa-lg mlr-10 "></i>Courses</p>
                    <p> <i className="fa-solid fa-podcast fa-lg mlr-10 "></i>Podcasts</p>
                </section>
                ...
                <section className="bb-2">
                    ...
                    <p><i className="fa-brands fa-youtube red fa-lg mlr-10"></i>Youtube Premium</p>
                    <p><i className="fa-brands fa-youtube fa-lg mlr-10 red"></i>Youtube Music</p>
                    <p><i className="fa-brands fa-youtube fa-lg mlr-10 red"></i>Youtube Kids</p>
                </section>

                {/* setting ,feedback and help section  */}

                <section className="bb-2">
                    <p><i className="fa-solid fa-gear fa-lg mlr-10"></i> Settings</p>
                ...
                <h4>About Press Copyright Contact us Creators Advertise Developers </h4> 
                <h4>  Terms Privacy Policy & Safety How YouTube works Test new features </h4> 
      ...
      {/* youtube logo  */}
<Link to="/">
<svg xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt10" width="93" height="20" viewBox="0 0 93 20" focusable="false" aria-hidden="true" className="ml-80">
  <g>
